...
export function MetalsSubsystemPanel({ components, contribution, rawHistory = {}, smoothedHistory = {} }: MetalsSubsystemPanelProps) {
    ...
    <div className="bg-gradient-to-br from-amber-950/20 to-stealth-850 border border-amber-900/30 rounded-lg p-4 md:p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-amber-400">{contribution.toFixed(1)}%</div>
